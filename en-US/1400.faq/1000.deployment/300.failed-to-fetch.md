|slug|what-do-i-do-when-failed-to-fetch-error-is-reported|
|---|---|
...
When you log in to the console of OceanBase Migration Service (OMS) Community Edition, a `Failed to fetch` error is reported.
...
1. Log in as the root user to the host where OMS Community Edition is deployed.
