...
The following requirements apply to different data migration task scenarios. The actual character set of Latin1 is UTF-8. In other words, the data stored at the source is in the UTF-8 character set. You must configure the source and sink based on the principles described in the "OMS Community Edition Solution" module.
