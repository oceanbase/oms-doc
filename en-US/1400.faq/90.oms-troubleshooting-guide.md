...
5. In the **<UI-TERM key="oms-community.Detail.components.SyncMonitorDrawer.ViewComponentMonitoring">View Component Monitoring</UI-TERM>** dialog box, view the **<UI-TERM key="oms-community.Detail.components.SyncMonitorDrawer.ComponentId">Component ID</UI-TERM>** of the Full-Import component for full migration.
...
The only difference from incremental synchronization is the component ID naming convention. A reverse incremental synchronization component ID contains the **reverse** keyword.
...
Slice generation -> Source reads from the source -> Dispatcher distributes records -> Sink writes to the destination
...
| oceanbase.__all_meta_table | Table metadata information for versions later than 20200 |
...
-- Query macroblock information. store_type=1 indicates normal data, and store_type=4 indicates a dump.
-- For versions earlier than 20200.
