...
* Troubleshooting method: Obtain the following logs and perform troubleshooting according to these logs or information on the **View Component Monitoring** page.
  ...
  * Store logs for store synchronization tasks. You can check the latest pull time of Store on the **View Component Monitoring** page to determine whether the data pulled by Store lags behind.
