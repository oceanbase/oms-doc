...
7. Return to the **Data Migration Task** page and modify the parameters.

   1. Log on to the OMS console. In the left-side navigation pane, click **Data Migration**.

   2. In the **Migration Tasks**  list, click the name of the target task to go to its details page.
