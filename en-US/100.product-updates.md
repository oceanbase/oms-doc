...
* Supports the wildcard DB feature in wildcard incremental scenarios. This feature supports the selection of a backward incremental start point during a forward switchover by adding the new wildcard DB to the whitelists of Store and incremental components.
...
* Optimized the component blacklist and whitelist configurations.
