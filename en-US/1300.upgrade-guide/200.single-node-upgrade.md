...
1. Back up the databases.
   ...
   1. Suspend the container of OMS Community Edition V4.2.5 and record the time as T1.
...
3. Start a new container for OMS Community Edition V4.2.6.
...
7. (Optional) To roll back OMS Community Edition, perform the following steps:
   ...
   4. Restart the old container of OMS Community Edition V4.2.5.
