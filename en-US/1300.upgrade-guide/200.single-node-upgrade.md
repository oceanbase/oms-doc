...
This topic describes how to upgrade OceanBase Migration Service (OMS) to V4.2.2-CE in single-node deployment mode.
...
1. Back up the databases.
   ...
   1. Suspend the container of OMS V4.2.1-CE and record the time T1.
...
3. Start a new container for OMS Community Edition V4.2.2.
...
7. Optional. To roll back, perform the following steps:
   ...
   4. Restart the old container of OMS Community Edition V4.2.1.
