...
## Which versions of OMS can be upgraded to V4.1.0-CE?

OMS V3.2.2-CE, V3.3.0-CE, V3.3.1-CE and V4.0.0-CE can be directly upgraded to OMS V4.1.0-CE.
...
## What do I do to resolve configuration compatibility issues when I upgrade OMS V3.2.2-CE to V4.1.0-CE?
