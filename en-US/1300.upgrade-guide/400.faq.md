...
## Which versions of OMS can be upgraded to V4.2.0-CE?

Currently, it is only supported to upgrade from OMS Community Edition V4.1.1 to Community Edition V4.2.0.
...
## What do I do to resolve configuration compatibility issues when I upgrade OMS V3.2.2-CE to V4.2.0-CE?
