...
1. Download the RPM package of obcdc from [OceanBase Download Center](https://www.oceanbase.com/softwarecenter).
    ...
    Find the **OceanBase Capture Data Change (OB CDC)** panel, click the version number in the upper right corner, select the version of your database, and download the RPM package for the corresponding system architecture.
