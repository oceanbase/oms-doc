...
This topic describes the background and restrictions for upgrading to OceanBase Migration Service (OMS) V4.1.0-CE.
...
3. Start the container of OMS V4.1.0-CE.

   The name of the MetaDB for the container of OMS V4.1.0-CE must be the same as that of the previous MetaDB. In addition, the three disk mounting paths must be the same as those before the upgrade.
