...
* Currently, it is only supported to upgrade from OMS Community Edition V4.1.1 to Community Edition V4.2.1. Upgrading from versions lower than Community Edition V4.1.1 to Community Edition V4.2.1 is not supported.
