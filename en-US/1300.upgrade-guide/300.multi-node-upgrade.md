# Upgrade OMS Community Edition to V4.2.10-CE

This topic describes how to upgrade OceanBase Migration Service (OMS) Community Edition from V4.2.0-CE to V4.2.10-CE.

<main id="notice" type='notice'>
<h4>Notice</h4>
<p>OMS Community Edition can be upgraded from V4.2.0-CE to V4.2.9-CE to V4.2.10-CE. OMS Community Edition earlier than V4.2.0-CE cannot be upgraded to V4.2.10-CE. </p>
</main>
...
2. Back up the database.
   ...
   1. Log in to IP1 and IP2, respectively, and stop the OMS Community Edition V4.2.9-CE containers on the two machines.
   ...
   3. Execute the following command to manually back up the rm, cm, and cm_hb databases to SQL files and confirm that the sizes of the files are not 0.
...
4. Start the OMS Community Edition V4.2.10-CE container.
   ...
   <ul>
   <li>
   <p>When you start the OMS Community Edition V4.2.10-CE container, the paths of the three mounted disks must be consistent with those before the upgrade. <br>You can execute the <code>sudo docker inspect ${CONTAINER_NAME} | grep -A5 'Binds'</code> command to view the paths of the disks mounted in the previous OMS Community Edition container.</p>
   </li>
   <li>
   <p>OMS Community Edition V3.3.1-CE and later versions support the new parameter <code>-e IS_UPGRADE=true</code>. This parameter is only applicable in upgrade scenarios and must be added in such scenarios.</p>
   </li>
   <li>
...
6. In the `root` directory, execute the metadata initialization operation.
   ...
   <ul>
   <li>
   <p>After you execute the preceding command, the script automatically applies schema changes to the three databases of OMS Community Edition.</p>
   </li>
   <li>
   ...
   2. In the `rm` database, execute the following SQL statement:
...
7. After the `docker_init.sh` script is executed, confirm that the machine list is normal and all machines are in the **<UI-TERM key="oms-community.Operation.constants.Online">Online</UI-TERM>** state.
   ...
   3. On the **<UI-TERM key="oms-community.Operation.Machine.MachineList">Servers</UI-TERM>** page, view the machine list and confirm that the status of all machines is **<UI-TERM key="oms-community.Operation.constants.Online">Online</UI-TERM>**.
...
9. (Optional) If you need to roll back, perform the following steps.
    ...
    1. Disable the HA feature based on the operation in Step 1.
    ...
    3. Connect to the metadata database and execute the following command.
    ...
    5. Start the OMS Community Edition V4.2.9-CE container.
