# Upgrade OMS Community Edition V4.2.10-CE

This topic describes how to upgrade OceanBase Migration Service (OMS) Community Edition from V4.2.0-CE to V4.2.10-CE.

<main id="notice" type='notice'>
<h4>Notice</h4>
<p>OMS Community Edition V4.2.10-CE can only be upgraded from V4.2.0-CE to V4.2.9-CE. Upgrading from versions earlier than V4.2.0-CE to V4.2.10-CE is not supported.</p>
</main>
...
2. Back up the database.
   ...
   1. Log in to IP1 and IP2, and stop the OMS Community Edition V4.2.9-CE service in the old container on the two servers.
...
In multi-region scenarios, the cm_hb databases in all regions need to be backed up. For example, if there are two regions, four databases need to be backed up: rm, cm, cm_hb1, and cm_hb2.
      ...
      | rm_429, cm_429, cm_hb_429 | Back up the rm, cm, and cm_hb databases as SQL files in the format of `database name > path to store the SQL file.sql`. Specify the actual values. |
...
9. (Optional) If you want to perform a rollback operation, perform the following steps.
    ...
    5. Restart the OMS Community Edition V4.2.9-CE container.