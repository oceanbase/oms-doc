...
2. Back up the database.
   ...
   1. Log in to the two hosts where the container of OMS Community Edition V4.2.7 is deployed by using their respective IP addresses, and suspend the container.
...
9. (Optional) To roll back OMS Community Edition, perform the following steps:
    ...
    6. On the **System Parameters** page, enable HA, and set the interval for pulling stores by specifying the `refetchStoreIntervalMin` parameter.
...
10. After the upgrade is complete, clear the browser cache before you log in to OMS Community Edition.
