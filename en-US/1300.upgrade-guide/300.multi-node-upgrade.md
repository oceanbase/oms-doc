...
* Before and during the upgrade, make sure that no users are creating data migration or synchronization tasks by using OMS Community Edition.
...
8. Check whether the data migration and synchronization tasks are successful and whether the components are running properly.
...
<p>No data migration or synchronization tasks are created in OMS Community Edition V4.2.3. </p>
