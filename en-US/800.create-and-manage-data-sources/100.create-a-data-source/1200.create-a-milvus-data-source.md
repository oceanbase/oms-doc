...
Before you create a data migration or synchronization task, you must create the data sources. This topic describes how to create a Milvus data source in OceanBase Migration Service (OMS) Community Edition.
...
4. In the **Create Data Source** dialog box, select **Milvus** for **Data Source Type**.
