|slug|create-a-mysql-data-source|
|---|---|

# Create a MySQL data source

You must configure data sources before you create a data migration task. This topic describes how to create a MySQL data source in OceanBase Migration Service (OMS) Community Edition.
