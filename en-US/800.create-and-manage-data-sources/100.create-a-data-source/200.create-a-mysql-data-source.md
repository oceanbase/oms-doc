...
You must configure data sources before you create a data migration task. Before you start a data migration task, you must add a MySQL database as the source or target data source. This topic describes how to create a MySQL data source in OceanBase Migration Service (OMS) Community Edition.
...
3. On the **<UI-TERM key="oms-community.pages.Endpoint.DataSourceManagement">Data Source Management</UI-TERM>** page, click **<UI-TERM>New Data Source</UI-TERM>** in the upper-right corner.

4. In the **<UI-TERM>New Data Source</UI-TERM>** dialog box, select **MySQL** for **<UI-TERM key="oms-community.pages.EndpointPublic.DataSourceType">Data Source Type</UI-TERM>**.
...
6. Click **<UI-TERM key="oms-community.Notification.Setting.AlarmChannelModal.TestConnection">Test Connection</UI-TERM>** to verify the network connection between OMS Community Edition and the data source, as well as the validity of the username and password. You can specify a database as the source or target.
