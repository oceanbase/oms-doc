...
5. Specify the following parameters.
   ...
   | keytab Certificate        | Click **<UI-TERM key="oms-community.components.KafkaForm.FileUploader.UploadObjects">Upload File</UI-TERM>** and upload a key file suffixed with `.keytab`.  This parameter is displayed only when you set Authentication Method to GSS-API.                                                                                                                                                                                                                                                                                                                                                                    |
