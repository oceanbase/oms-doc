...
## User privileges required when a ClickHouse database serves as the source
...
* The database user must have the `SELECT` privilege on the database to be migrated.
