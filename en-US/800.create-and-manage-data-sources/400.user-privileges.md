...
When an ElasticSearch database serves as the target data source, the user must have the `create_index`, `write`, and `view_index_metadata` privileges.
