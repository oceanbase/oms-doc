...
3. Use the `GRANT` statement to grant permissions to the database user. For more information, see [User privileges](../800.create-and-manage-data-sources/400.user-privileges.md).
