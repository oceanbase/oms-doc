...
4. Create a role and grant privileges. For more information, see [User privileges](../800.create-and-manage-data-sources/400.user-privileges.md).

## StarRocks data source

The StarRocks database user created here is used for the **<UI-TERM key="oms-community.pages.Endpoint.DatabaseUsername">Database username</UI-TERM>** field when you create a StarRocks data source.
...
1. Log in with the ClickHouse database user account.
...
3. Grant privileges to the database user by using the `GRANT` statement. For more information, see [User privileges](../800.create-and-manage-data-sources/400.user-privileges.md).