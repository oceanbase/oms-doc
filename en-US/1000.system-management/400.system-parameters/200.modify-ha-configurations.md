...
5. In the **<UI-TERM key="oms-community.pages.SystemParam.ModifyAValue">Modify Value</UI-TERM>** dialog box, change the value as needed.

6. Click **<UI-TERM key="oms-community.Endpoint.New.Add">OK</UI-TERM>**.
