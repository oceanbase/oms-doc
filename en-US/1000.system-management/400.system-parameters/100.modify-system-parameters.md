...
4. In the **<UI-TERM key="oms-community.pages.SystemParam.ModifyAValue">Modify Value</UI-TERM>** dialog box, set **<UI-TERM key="oms-community.pages.SystemParam.Value">Value</UI-TERM>** or click **<UI-TERM key="oms-community.SystemParam.components.CfgValueInput.RestoreTheDefaultValue">Reset to Default</UI-TERM>**.
