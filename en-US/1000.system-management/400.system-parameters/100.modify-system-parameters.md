...
4. In the **<UI-TERM key="oms-community.pages.SystemParam.ModifyAValue">Modify Value</UI-TERM>** dialog box, set **<UI-TERM key="oms-community.pages.SystemParam.Value">Value</UI-TERM>** or click **Reset to Default**.
...
You can log in to the console of OMS Community Edition, go to the details page of a data migration task, and view the names of the precheck items on the **Pre-check** tab, which are prefixed with "Source-" or "Target-".
