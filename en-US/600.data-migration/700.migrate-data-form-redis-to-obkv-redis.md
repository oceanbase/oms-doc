...
2. On the **Select Source and Target** page, configure the parameters.
   ...
   | Target    | If you have created an OBKV-Redis data source, select it from the drop-down list. If not, click **New Data Source** in the drop-down list and create one in the dialog box that appears on the right.   |
