...
4. Click **Next**. On the **Select Migration Objects** page, select the migration objects and migration scope.
   ...
   * Select **Specify Objects**. Then select the objects to be migrated on the left and click **\>** to add them to the list on the right.
      ...
      <li>
      <p>When you choose the <b>Specify Objects</b> option, you can select tables only from the <code>default</code> list. If you want to select other tables, choose the <b>Match Rules</b> option and specify a rule in the form of <code>db.*</code>. </p>
      </li>
      </ul>
      </main>
