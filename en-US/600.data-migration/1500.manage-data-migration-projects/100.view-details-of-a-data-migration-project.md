...
* View migration objects
   ...
   Click **View Objects** in the upper-right corner. The migration objects of the current data migration task are displayed. You can also modify the migration objects of an ongoing data migration object. For more information, see [View and modify migration objects](../1500.manage-data-migration-projects/200.view-and-modify-migration-objects.md).
