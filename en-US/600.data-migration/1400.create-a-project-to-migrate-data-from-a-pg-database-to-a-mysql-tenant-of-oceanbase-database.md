...
You can create a data migration task in the console of OMS Community Edition to seamlessly migrate the existing business data and incremental data from a PostgreSQL database to OceanBase Database Community Edition through schema migration, full migration, and incremental synchronization.
...
4. In the dialog box that appears, click **OK**.
   ...
   Note that this task supports only tables with a primary key or a non-null unique index and other tables are automatically filtered out.
