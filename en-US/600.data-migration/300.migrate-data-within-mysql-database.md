...
This topic describes how to use OceanBase Migration Service (OMS) Community Edition to migrate data between two MySQL databases.
...
* You have created dedicated database users for data migration in the source and destination databases, and granted required privileges to the users. For more information, see [Create a database user](../800.create-and-manage-data-sources/300.create-a-database-user.md).
...
* At present, MySQL 5.5, 5.6, 5.7, and 8.0 are supported. OMS Community Edition supports the InnoDB, TokuDB, and X-Engine storage engines of MySQL. Other engines do not support data migration.
...
5. Click **Next**. On the **Migration Options** page, configure the parameters.
   ...
   * Full data migration
      ...
      | Whether to Allow Post-indexing | Specifies whether to create indexes after the full data migration is completed. Post-indexing can shorten the time required for full data migration. <main id="notice" type='notice'><h4>Notice</h4><p>This feature is supported only if you have selected both <b>Schema Migration</b> and <b>Full Data Migration</b> on the <b>Select Migration Type</b> page. </p> </main> |
   ...
   * Full verification
      ...
      | Parameter | Description |
      |----|----------------------------------|
      | Concurrency Speed | Valid values: **Stable**, **Normal**, **Fast**, and **Custom**. Resources consumed in the source and destination databases vary based on the specified concurrency. If you select **Custom**, you can set **Read Concurrency**, **Write Concurrency**, and **JVM Memory** as needed.  |
