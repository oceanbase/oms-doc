...
## Limitations
  ...
  <main id="notice" type='notice'>
    <h4>Notice</h4>
    <p>Due to the limitations of MySQL tenants of OceanBase Database, an error may be returned when the synchronized DDL statements are converted and executed in a MySQL tenant of OceanBase Database in the following scenarios. For more information, see the official documentation of OceanBase Database Community Edition. </p>
  </main>
