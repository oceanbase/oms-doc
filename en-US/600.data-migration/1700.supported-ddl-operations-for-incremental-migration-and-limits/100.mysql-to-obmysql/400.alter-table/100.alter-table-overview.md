|slug|alter-table-overview|
|---|---|

# Modify a table

This topic describes the supported conversion scope of ALTER TABLE DDL operations during data migration from a MySQL database to a MySQL-compatible tenant of OceanBase Database.
