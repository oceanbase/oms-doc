|slug|change-length-of-a-constrained-column|
|---|---|

# Change the length of a constrained column

This topic describes incompatibilities between MySQL databases and MySQL-compatible tenants of OceanBase Database when you change the length of a constrained column. The incompatibilities vary depending on the constraint.
...
The following table describes the operations that you can perform to change the length of a PRIMARY KEY column by executing the ALTER TABLE table_name MODIFY/CHANGE COLUMN DDL statement in a MySQL database and a MySQL-compatible tenant of OceanBase Database.
...
The following table describes the operations that you can perform to change the length of a FOREIGN KEY column by executing the ALTER TABLE table_name MODIFY/CHANGE COLUMN DDL statement in a MySQL database and a MySQL-compatible tenant of OceanBase Database.
...
The following table describes the operations that you can perform to change the length of a FULLTEXT indexed column by executing the ALTER TABLE table_name MODIFY/CHANGE COLUMN DDL statement in a MySQL database and a MySQL-compatible tenant of OceanBase Database.
