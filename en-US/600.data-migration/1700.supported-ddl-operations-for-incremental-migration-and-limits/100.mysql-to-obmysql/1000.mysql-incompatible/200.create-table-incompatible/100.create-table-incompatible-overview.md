|slug|create-table-incompatible-overview|
|---|---|
...
* When you create a constraint, the column types supported in a MySQL database are different from those supported in a MySQL-compatible tenant of OceanBase Database. For more information, see [Column types that are supported to create indexes or constraints](../200.create-table-incompatible/200.create-index-incompatible.md).
