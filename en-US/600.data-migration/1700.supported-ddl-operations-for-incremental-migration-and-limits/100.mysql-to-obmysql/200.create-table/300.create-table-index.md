|slug|create-an-index-or-a-constraint|
|---|---|

# Create an index or a constraint

This topic describes the supported conversion scope of CREATE TABLE DDL operations for creating indexes or constraints during data migration from a MySQL database to a MySQL-compatible tenant of OceanBase Database.
...
* Create CHECK constraints in MySQL-compatible tenants of OceanBase Database V3.2.3 and later.
