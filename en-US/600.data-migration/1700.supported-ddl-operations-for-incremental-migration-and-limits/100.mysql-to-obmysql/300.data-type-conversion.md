...
<table>
    ...
    <td><b>MySQL-compatible tenant of OceanBase Database</b></td>
    </tr>
    <tr>
...
| MySQL databases | MySQL-compatible tenants of OceanBase Database |
|-------|-----------------|
| JSON | TEXT (for MySQL-compatible tenants of OceanBase Database of a version earlier than V3.2.3) or JSON (for MySQL-compatible tenants of OceanBase Database V3.2.3 and later)<br>  |
