...
> **Notice**
>
> If you have created an `index` in the source tenant and it also exists in the destination tenant, OMS Community Edition automatically ignores the `index` without interrupting the migration process.
