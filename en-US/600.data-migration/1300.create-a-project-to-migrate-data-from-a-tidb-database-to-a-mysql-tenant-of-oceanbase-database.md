...
* OMS Community Edition does not support the migration of tables without primary keys and data with spaces from a TiDB database to OceanBase Community Edition.
