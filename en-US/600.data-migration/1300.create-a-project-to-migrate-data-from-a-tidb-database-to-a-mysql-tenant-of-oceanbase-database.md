...
8. Click **Next**. On the **Migration Options** page, configure the following parameters.
   ...
   To view or modify parameters of the Full-Import or Incr-Sync component, click **Configuration Details** in the upper-right corner of the **Full Data Migration** or **Incremental Synchronization** section. For more information about the parameters, see [Component parameters](../1100.o-m-guide/500.component-parameters/100.coordinator.md).
