...
After the precheck succeeds, the data migration task proceeds to the **Schema Migration** step. On the details page of the data migration task, you can click the **Schema Migration** tab to view the overall status, start time, end time, and total duration of the schema migration task, as well as the migration progress of tables and views.
