...
* You have verified data consistency between the source and destination, and you want to create a data migration task to obtain the incremental data generated after a specific point in time and synchronize the data to the destination database.
...
1. Create a data migration task and go to the **Select Migration Type** step as prompted.

	For more information, see the topic about creating a data migration task between the corresponding data sources in [Data migration](../100.data-migration-overview.md).
...
4. Click **Precheck**. After the precheck succeeds, start the data migration task.
