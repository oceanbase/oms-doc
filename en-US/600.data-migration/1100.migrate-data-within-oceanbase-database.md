...
2. On the **Select Source and Destination** page, configure the parameters.
   ...
   | Scenarios | Two scenarios are available: **Data Migration** and **Active-Active Disaster Recovery**. Select **Data Migration**. To create a migration project in an active-active disaster recovery scenario, you need to select **Active-Active Disaster Recovery**.   |
