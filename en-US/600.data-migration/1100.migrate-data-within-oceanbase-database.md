...
You can create a data migration task in the console of OMS Community Edition to migrate the existing business data and incremental data between instances of OceanBase Database Community Edition through schema migration, full migration, and incremental synchronization.
...
* OMS Community Edition allows you to migrate both tables with a primary key and tables without a primary key between instances of OceanBase Database Community Edition.
...
* In a task that migrates data between instances of OceanBase Database Community Edition of a version earlier than V3.2.x, if a source table is a multi-partition table with a global unique index and the values of the partitioning key of the table are updated, data can be lost during the migration.
...
7. Click **Next**. On the **Migration Options** page, configure the following parameters.
   ...
   * Schema migration
      ...
      Parameters in this section are displayed only if **Schema Migration** is selected on the **Select Migration Type** page, the source is an instance of OceanBase Database Community Edition of a version later than V4.0.0, and the target is an instance of OceanBase Database Community Edition V4.0.0 or earlier. You can configure the **Character Set Mapping** and **Collation Mapping** parameters as needed.
