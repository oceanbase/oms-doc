...
This topic describes how to use OceanBase Migration Service (OMS) Community Edition to migrate incremental data from OBKV to HBase database. 

## Limitations

* Only HBase 1.2.0-cdh5.15.2 and 2.4.13 are supported.

* The format of an OBKV table name is `TableName$ColumnFamilyName`, and incremental synchronization tasks only support migration of tables in this format.
...
3. Click **Next**. On the **Select Migration Type** page, configure the parameters.
    ...
    At present, only DML Synchronization is supported for Incremental Synchronization. For more information, see [DML Synchronization](../600.data-migration/1600.migration-function-introduction/100.migration-dml.md).
