...
You can create a data migration task in the console of OMS Community Edition to migrate incremental data from OBKV to an HBase database. For more information about OBKV, see [Overview](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001970954).
