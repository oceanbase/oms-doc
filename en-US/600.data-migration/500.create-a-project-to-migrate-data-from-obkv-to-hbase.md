...
You can create a data migration task in the console of OMS Community Edition to migrate incremental data from OBKV to an HBase database. For more information about OBKV, see [Overview](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000000900468).

## Limitations

* Only HBase 1.2.0-cdh5.15.2 and 2.4.13 are supported.

* Only data of a table named in the format of `TableName$ColumnFamilyName` in OBKV can be migrated by an incremental synchronization task.
...
5. Click **Next**. On the **Migration Options** page, configure the parameters of incremental synchronization.
