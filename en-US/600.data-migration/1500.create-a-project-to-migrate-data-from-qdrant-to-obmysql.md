...
6. Click **Next**. On the **Migration Options** page, configure the parameters.
      ...
      To view or modify parameters of the full migration component Checker-Full, click **Configuration Details** in the upper-right corner of the **Full Migration** section. For more information about the parameters, see [Component parameters](../1100.o-m-guide/500.component-parameters/100.coordinator.md). The following table describes the parameters of the Qdrant data source.
