...
6. Click **Next**. On the **Migration Options** page, configure the parameters.
    ...
    <main id="notice" type='notice'>
      ...
      To view or modify parameters of the full migration component Full-Import, click **Configuration Details** in the upper-right corner of the **Full Migration** section. For more information about the parameters, see [Component parameters](../900.o-m-manual/400.components/500.component-parameters/100.coordinator.md). The following table describes the parameters of the Qdrant data source.
