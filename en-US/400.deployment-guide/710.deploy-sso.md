...
This section describes how to log in to OMS Community Edition deployed on a single node. If you want to deploy OMS Community Edition on multiple nodes in a single region, see the "Deployment procedure with a configuration file" section in [Single-region multi-node deployment](../400.deployment-guide/500.docker-deploy/200.deploy-oms-on-multiple-nodes-in-a-single-region.md).
