...
|---------------------|-------------------------------------------|---------------------------------------------------|
| oms_meta_host       | The IP address of the MetaDB cluster, which can be that of a MySQL database or a MySQL tenant of OceanBase Database Community Edition. <br> **Notice** <br> This parameter is valid only in OceanBase Database V2.0 and later.        | Yes                |
