...
3. Log on to the OMS console and go to the **<UI-TERM key="oms-community.Operation.Machine.MachineList">Servers</UI-TERM>** page to check whether the number of servers is as expected.
