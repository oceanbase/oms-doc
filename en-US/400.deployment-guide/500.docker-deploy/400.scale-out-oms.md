...
The specific steps are the same as those for the initial single-node deployment. For more information, see [Deploy OMS Community Edition on a single node](../500.docker-deploy/100.deploy-oms-on-a-single-node.md).
