|slug|single-node-deployment-docker|
|---|---|
...
5. Complete the deployment as prompted. After you set each parameter, press **Enter** to move on to the next parameter.
   ...
   4. Enter the configuration information for OMS Community Edition as follows:
      ...
      3. The page displays the settings of OMS Community Edition. Note that the value of the `cm_url` parameter must be the IP address of the server. Check whether the custom ports are correct. If yes, enter `y` and press **Enter** to proceed. Otherwise, enter `n` and press **Enter** to modify the settings.
   ...
   10. Specify the directory to which OMS Community Edition is mounted on the node.

       Specify a directory with a large capacity.

   11. Confirm whether the image file of OMS Community Edition can be named `<OMS_IMAGE>`.
...
If the configuration file of OMS Community Edition exists, you can use the deployment tool to verify the configuration file and directly use the file.
...
4. Use the deployment script to start the deployment tool.
   ...
   <main id="notice" type='explain'>
    <h4>Note</h4>
    <p>The value of the <code>-c</code> option must be the absolute path of the <code>config.yaml</code> configuration file. </p>
   </main>
...
5. Complete the deployment as prompted. After you set each parameter, press **Enter** to move on to the next parameter.
   ...
   8. Start the deployment.
         ...
         * During the deployment, you can run the `docker logs -f <OMS Community Edition container name>` command to view the initialization status.
            ...
            To view all the initialization logs, you can run the `docker logs <OMS Community Edition container name>` command.
