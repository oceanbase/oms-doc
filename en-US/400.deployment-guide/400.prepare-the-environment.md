...
* Graphical interface deployment: For more information, see [Deploy OMS](https://www.oceanbase.com/docs/common-obd-cn-1000000005151015).

* Command-line deployment: For more information, see [Deploy OMS](https://www.oceanbase.com/docs/common-obd-cn-1000000005151037).
...
2. Prepare a database to store the OMS Community Edition metadata.
   ...
   <h4>Notice</h4>
   <p>The password of the metadata database user cannot be empty and cannot contain special characters (including line breaks, spaces, and |"'`()=;/&[]{}).</p>
   </main>
