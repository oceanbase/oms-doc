...
This topic describes how to deploy OceanBase Migration Service (OMS) Community Edition in multiple regions and nodes. The example uses Hangzhou and Beijing as the regions.
...
1. Log in to the k8s environment and prepare the configuration files for each region.
    ...
    * Hangzhou region
        ...
        template:
            ...
            - name: writable-config
                emptyDir: {}
        # The following three mount disks are for storing logs, incremental data, and running data. You can increase the size of these disks based on your business requirements.
