|slug|resource-configuration-specifications|
|---|---|
...
The following table shows standard resource specifications of OMS Community Edition components for the data migration from a MySQL database to a MySQL-compatible tenant of OceanBase Database.
