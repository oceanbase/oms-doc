...
5. Complete the deployment as prompted. After you set each parameter, press **Enter** to move on to the next parameter.
   ...
   4. Enter the configuration information for OMS Community Edition as follows:
      ...
      3. The page displays the settings of OMS Community Edition. Check whether the value of the `cm_url` parameter is the IP address of the server and whether the custom ports are correct. If yes, enter `y` and press **Enter** to proceed. Otherwise, enter `n` and press **Enter** to modify the settings.
