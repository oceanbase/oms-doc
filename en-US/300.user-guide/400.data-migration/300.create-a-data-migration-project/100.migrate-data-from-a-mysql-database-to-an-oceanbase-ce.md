|slug|migrate-data-from-a-mysql-database-to-an-oceanbase-ce|
|---|---|
...
* You have enabled binlogs for the self-managed MySQL database. For more information, see [Enable binlogs for a MySQL database](../../200.users-and-privileges/300.enable-binlogs-for-the-mysql-database.md).
