...
2. On the **Select Source and Destination** page, configure the parameters.
   ...
   | Tag (Optional) | Click the field and select a target tag from the drop-down list. You can click **Manage Tags** to create, modify, and delete tags. For more information, see [Manage data synchronization projects by using tags](../7.data-synchronization/11.manage-a-data-synchronization-projects/3.use-tags-to-manage-data-synchronization-projects.md).  |
   ...
   | Destination | If you have created a Kafka data source, select it from the drop-down list. Otherwise, select **Create Data Source** from the drop-down list to add one in the dialog box on the right side. For more information, see [Create a Kafka data source](../8.create-and-manage-data-sources/1.create-a-data-source/5.create-a-kafka-data-source.md).  |
...
6. Click **Next**. On the **Synchronization Options** page, specify the following parameters.
   ...
   | Serialization Method | The message format for synchronizing data to a Kafka instance. Valid values: **Default**, **Canal**, **Dataworks** (version 2.0), **SharePlex**, **DefaultExtendColumnType**, and **Debezium**. For more information, see [Data formats](../7.data-synchronization/16.data-formats.md).  |
