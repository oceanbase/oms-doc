...
After you log on to the OMS Community Edition console, the **Overview** page automatically appears. The page displays the general information of data migration and synchronization tasks, resource usage, and task status of each OMS Community Edition module.
...
After you log on to the OMS Community Edition console, click **Data Migration** in the left-side navigation pane. On the **Data Migration** page, you can create and manage data migration tasks. For more information, see [Data migration](../600.data-migration/100.data-migration-overview.md).
