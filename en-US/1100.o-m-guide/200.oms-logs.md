...
4. Click **<UI-TERM key="oms-community.Migration.Detail.ViewComponentMonitoring">View Component Monitoring</UI-TERM>** in the upper-right corner and view the ID of the Full-Import or Incr-Sync component.
   ...
   * Choose **O&M and Monitoring** > **<UI-TERM key="oms-community.Operation.OperationComponent.Component">Component</UI-TERM>** > **Full-Import/Incr-Sync**. Click the **<UI-TERM key="oms-community.project.cloudweb.MoreOperations">More</UI-TERM>** icon in the Actions column of the target component and select **<UI-TERM key="oms-community.Migration.constants.ViewLogs">View Logs</UI-TERM>** from the drop-down list.
...
4. Click **<UI-TERM key="oms-community.Migration.Detail.ViewComponentMonitoring">View Component Monitoring</UI-TERM>** in the upper-right corner and view the ID of the corresponding Full-Verification component.
   ...
   * Choose **O&M and Monitoring** \> **<UI-TERM key="oms-community.utils.hooks.useLayoutMenus.Components">Component</UI-TERM>** \> **Full-Verification**. Click the More icon in the Actions column of the target Full-Verification component and select **<UI-TERM key="oms-community.Operator.constants.ViewLogs">View Logs</UI-TERM>** from the drop-down list.
