...
| `logs/msg/connector_sink_msg.log` | Messages indicating that data is successfully written to the target database.  |
| `logs/msg/connector_source_msg.log` | Messages indicating that data fails to be written to the target database.  |
