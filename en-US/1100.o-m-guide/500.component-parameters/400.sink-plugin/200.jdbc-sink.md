...
* Default value: false.
   ...
   For a data migration task not between a MySQL database and a MySQL tenant of OceanBase Database, this parameter will be automatically set to false even if you set it to true.
