...
OceanBase Migration Service (OMS) Community Edition V4.2.1 and later support data migration from an HBase database to OBKV. This topic describes the parameters of HBaseSink.
