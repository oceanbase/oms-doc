...
* Displays operational logs on the GUI.
   ...
   In conventional O&M scenarios, to troubleshoot a specific task or component, you must log in to the corresponding server and view the operational or error logs. However, OMS Community Edition allows you to view the logs in a specified path in the console, facilitating troubleshooting.
