...
| docAsField | Specifies whether to treat the entire document as a field in OceanBase Database Community Edition. The value is a BOOLEAN. The default value is `false`.<br>When you set docAsField to `true`, the `_id` field is migrated by default. In this case, you must specify `mongoIdName`. |
