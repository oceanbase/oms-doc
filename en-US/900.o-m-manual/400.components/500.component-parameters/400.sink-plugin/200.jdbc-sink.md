...
* Description: specifies the trust certificate path.
...
* Description: specifies the trust certificate password. client keystore path
...
* Description: specifies the client keystore path.
...
* Description: specifies the client keystore file password.
...
* Description: specifies whether to disable hostname verification.
