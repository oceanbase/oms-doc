...
* After you update the configurations of an Incr-Sync component, the system will restart the Incr-Sync component for the update to take effect. Proceed with caution.
   ...
   When a data migration or synchronization task fails, check the configurations of the project first, such as the basic information and user privileges of the source and destination databases.
