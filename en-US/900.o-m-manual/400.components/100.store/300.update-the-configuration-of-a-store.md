...
4. In the **Update Configuration** dialog box, add a parameter or update the configurations. For more information, see [Store parameters](../500.component-parameters/500.store-component-parameters/300.mysql-store.md).
