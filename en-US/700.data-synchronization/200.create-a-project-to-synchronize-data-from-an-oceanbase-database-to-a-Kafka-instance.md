...
6. Click **Next**. On the **Synchronization Options** page, specify the following parameters.
   ...
   | Serialization Method | The message format for synchronizing data to a Kafka instance. Valid values: **Default**, **Canal**, **Dataworks** (version 2.0), **SharePlex**, **DefaultExtendColumnType**, and **Debezium**. For more information, see [Data formats](../700.data-synchronization/1200.sync-function-introduction/700.data-formats.md).  |
