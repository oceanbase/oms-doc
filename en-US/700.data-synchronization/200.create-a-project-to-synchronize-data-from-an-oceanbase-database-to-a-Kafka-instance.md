...
* When data transfer is resumed for a task, some data (within the last minute) may be duplicated in the Kafka instance, and deduplication is required in downstream systems.
...
2. On the **Select Source and Destination** page, configure the parameters.
   ...
   | Tag (Optional) | Click the field and select a target tag from the drop-down list. You can also click **Manage Tags** to create, modify, and delete tags. For more information, see [Manage data synchronization tasks by using tags](1100.manage-a-data-synchronization-projects/300.use-tags-to-manage-data-synchronization-projects.md).  |
   ...
   | Destination | If you have created a Kafka data source, select it from the drop-down list. Otherwise, click **New Data Source** in the drop-down list to create one in the dialog box on the right side. For more information, see [Create a Kafka data source](../800.create-and-manage-data-sources/100.create-a-data-source/500.create-a-kafka-data-source.md).  |
