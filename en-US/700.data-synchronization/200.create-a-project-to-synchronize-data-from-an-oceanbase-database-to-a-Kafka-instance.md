...
* When the version of OceanBase Database is between V4.0.0 and V4.3.x (excluding V4.2.5 BP1) and you have selected **Incremental Synchronization**, configure the [STORED attribute](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001974216) for generated columns. Otherwise, the information of generated columns will not be saved in the incremental logs, which may lead to abnormal data during incremental synchronization.
