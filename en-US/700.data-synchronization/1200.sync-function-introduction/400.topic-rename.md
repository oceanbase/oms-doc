...
When you create a task to synchronize data from ApsaraDB for OceanBase to a message queue instance, the OMS feature allows you to rename topics by using the **Change Topic** feature after you specify the type of topics to be synchronized.

## Procedure

1. Create a data synchronization task and configure it to the **Select Synchronization Objects** step.
