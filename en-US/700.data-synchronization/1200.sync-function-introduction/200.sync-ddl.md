...
2. On the **<UI-TERM key="oms-community.Sync.New.SelectSynchronizationType">Select Synchronization Type</UI-TERM>** page, select **<UI-TERM key="oms-community.Sync.constants.IncrementalSynchronization">Incremental Synchronization</UI-TERM>** and then **<UI-TERM key="oms-community.components.MigrationParamsConfig.MigrationParamsDetail.SchemaChangeDdl">DDL Synchronization</UI-TERM>**
