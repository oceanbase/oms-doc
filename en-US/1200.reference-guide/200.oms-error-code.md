...
**Cause**: No store has been created for the current task, or all existing store processes have exited.
**Solution:**
...
2. Log on to the OMS console. Click **View Component Monitoring** in the upper-right corner of the current task page to view the component logs and check whether any error is reported.
...
Enterprise Edition: Log on to the OMS console. Click **View Component Monitoring** in the upper-right corner of the current task page to view the Store logs and check whether any error is reported.
...
Enterprise Edition: Submit a ticket. Log on to the OMS console. Click **View Component Monitoring** in the upper-right corner of the current task page to view the Checker logs and check whether any error is reported.
...
Enterprise Edition: Log on to the OMS console. Click **View Component Monitoring** in the upper-right corner of the current task page to view the Connector logs and check whether any error is reported.
...
**Cause**: The maximum length of a string field is 2 MB in DataHub.
