# Query precheck details

This topic describes the OpenAPI of OceanBase Migration Service (OMS) Community Edition: GetPreCheckResult.

## Description

This API is used to query the details of a precheck.
