|slug|delete-project-of-api|
|---|---|

# DeleteProject

This topic describes the DeleteProject API provided by OceanBase Migration Service (OMS) Community Edition.

## Overview

You can call this operation to delete a data migration or synchronization task.
