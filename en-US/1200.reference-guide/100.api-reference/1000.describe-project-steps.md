...
* **Parameters in stepInfo**
  ...
  * FULL_VERIFIER (full verification) and FULL_TRANSFER (full migration)
      ...
      | dstRps | long | The read/write RPS of the destination.  |
      | dstRt | long | The read/write RT of the destination. Unit: milliseconds/record.  |
      | dstIops | long | The read/write traffic of the destination. Unit: bytes/second.  |
      | srcRpsRef | long | The read RPS baseline of the source.  |
      | dstRpsRef | long | The read/write RPS baseline of the destination.  |
      | dstRtRef | long | The read/write RT baseline of the destination.  |
