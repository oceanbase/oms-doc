|slug|describe-project-steps-of-api|
|---|---|
...
* **Parameters in stepInfo**
  ...
  * FULL_VERIFIER (full verification) and FULL_TRANSFER (full migration)
      ...
      | srcRps | long | The read records per second (RPS) of the source.  |
      | srcRt | string | The read response time (RT) of the source. Unit: milliseconds/record.  |
      | srcIops | long | The read traffic of the source. Unit: bytes/second.  |
      | dstRps | long | The read/write RPS of the target.  |
      | dstRt | long | The read/write RT of the target. Unit: milliseconds/record.  |
      | dstIops | long | The read/write traffic of the target. Unit: bytes/second.  |
