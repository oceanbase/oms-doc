|slug|release-project-of-api|
|---|---|

# ReleaseProject

This topic describes the ReleaseProject API provided by OceanBase Migration Service (OMS) Community Edition.

## Overview

You can call this operation to release a data migration or synchronization task.
