|slug|describe-project-components-of-api|
|---|---|
...
* **Parameters in data**
   ...
   | reverseStoreList | array | The reverse increment pull component.  |
   | ├─ name | string | The name of the reverse increment pull component.  |
   | ├─ ip | string | The IP address of the server where the reverse increment pull component resides.  |
   | ├─ region | string | The region where the reverse increment pull component resides.  |
   | ├─ topic | string | The name of the message queue topic.  |
   | ├─ subtopic | string | The name of the message queue subtopic.  |
   | ├─ tps | integer | The TPS.  |
   ...
   | ├─ gmt | integer | The sampling time of the incremental synchronization timestamp.  |
   | ├─ conn | integer | The number of connections.  |
   | ├─ status | string | The status of the reverse increment pull component.  |
   | ├─ errorDetails | array | The error details.  |
   ...
   | ├─ gmtModify | string | The time when the component was modified, which is presented in the UTC+0 time zone.  |
   | ├─ errorDetails | array | The error details.  |
   | reverseIncrSyncComponents | array | The reverse increment component.  |
   | ├─ region | string | The region where the reverse increment component resides.  |
   | ├─ name | string | The name of the reverse increment component.  |
   | ├─ ip | string | The IP address of the server where the reverse increment component resides.  |
   | ├─ identity | string | The task ID.  |
   | ├─ subtopics | string | The name of the message queue subtopic.  |
   | ├─ status | string | The status of the reverse increment component.  |
   | ├─ checkpoint | string | The current timestamp, which is presented in the UTC+0 time zone.  |
   | ├─ tps | integer | The TPS.  |
   | ├─ delay | integer | The delay, in seconds.  |
   | ├─ checkpointSampleTimestamp | integer | The checkpoint sampling time. The value is a timestamp in seconds.  |
