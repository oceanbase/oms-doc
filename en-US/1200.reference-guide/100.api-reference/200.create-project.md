...
|    ├─ databases | array | The list of database objects. For more information, see the **<UI-TERM>Data structure of databases/databasesBlack</UI-TERM>** section. |
|    ├─ databasesBlack | array | The blocklist of database objects used for the `WILDCARD` mode. For more information, see the **<UI-TERM>Data structure of databases/databasesBlack</UI-TERM>** section. |
