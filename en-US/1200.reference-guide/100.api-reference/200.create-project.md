...
|   sourceEndpointId | string | The ID of the source. You must call the `ListDataSource` operation to obtain the ID, which is in the `e_****` format. |
