...
Access the details page of the migration task, click the **More** icon in the upper-right corner, and then choose **View Component Monitoring** to view the timestamp information about the store used for pulling logs and the JDBCWriter used for real-time synchronization.
