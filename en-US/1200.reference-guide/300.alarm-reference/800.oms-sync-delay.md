...
Go to the details page of the data synchronization task, and click **View Component Monitoring** in the upper-right corner to view the timestamp information of the store and connector components.
