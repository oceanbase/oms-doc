...
4. On the **Select Migration Type** page, specify related parameters.
   ...
   >**Notice:**
   >
   >If the destination is OceanBase Community Edition V4.0-CE, full data verification and reverse incremental migration are not supported.
