...
* You cannot use this statement to create a temporary table. The `TEMPORARY` keyword will be ignored.
   ...
   > **Note**
   >
   > You can create temporary tables in MySQL tenants of OceanBase Database V4.0.0.
...
* Create columns
  ...
  * Specify CHECK constraints (supported only in MySQL tenants of OceanBase Database V4.0.0). For more information, see Create indexes or constraints following this section.
  ...
  * The following table lists the supported data types.
    ...
    <table>
        ...
        <tr>
            ...
            <td>JSON</td>
            <td>TEXT (for MySQL tenants of OceanBase Database of a version earlier than V4.0.0) or JSON (for MySQL tenants of OceanBase Database V4.0.0 and later) </td>
        </tr>
    </table>
  ...
  * STORAGE
    ...
    Due to the limits of MySQL tenants of OceanBase Database, an error may be returned when the converted incremental DDL statements are synchronized to OceanBase Community Edition in the following scenarios:
...
* Create indexes or constraints
  ...
  * Create CHECK constraints in MySQL tenants of OceanBase Database V4.0.0 and later.
...
* Operate constraints and indexes
  ...
  * In MySQL tenants of OceanBase Database of a version earlier than V4.0.0, you cannot:
...
* TEMPORARY in MySQL tenants of OceanBase Database of a version earlier than V4.0.0
...
Due to the limits of MySQL tenants of OceanBase Database, you cannot create indexes on specific types of fields. Otherwise, an error may be returned when the converted incremental DDL statements are synchronized to OceanBase Community Edition.
