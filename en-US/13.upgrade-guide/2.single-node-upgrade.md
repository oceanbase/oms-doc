...
2. Back up the databases.
   ...
   1. Suspend the container of OMS V3.3.1 and record the time T1.
...
6. On the **System Parameters** page, enable HA, and configure the parameters.
...
7. Optional. To roll back, perform the following steps:
   ...
   5. Restart the container of OMS V3.3.0.
