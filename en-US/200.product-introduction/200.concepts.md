...
<table>
        ...
        <tr>
            ...
            <td>Supports data synchronization tasks in OMS Community Edition of versions earlier than V3.3.1.
            </td>
        </tr>
        <tr>
            <td>Incr-Sync</td>
            <td>The incremental synchronization component. It requests incremental data from the incremental pulling component Store, filters the data based on the configured synchronization objects, and synchronizes the log records to the target instance while ensuring the time series and consistency of transactions.
            </td>
        </tr>
        <tr>
            <td>Full-Import    </td>
        ...
        <tr>
            <td>InfluxDB    </td>
            <td>As a time series database service, InfluxDB is deployed in containers and stores the monitoring data of migration tasks in OMS Community Edition. </td>
        </tr>
</table>
