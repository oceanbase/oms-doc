...
| **Disaster recovery level** | **Supported?** | **Deployment requirement** | **<UI-TERM key="oms-community.User.Personal.Description">Description</UI-TERM>** |
| --- | --- | --- | --- |
...
| | **<UI-TERM key="oms-community.components.MonitorDrawer.LogPullComponent">Store</UI-TERM>** | **Incr-Sync** | **Full-Import** | **Full-Verification** |
| --- | --- | --- | --- | --- |
| **Server failure** | ✅ | ✅ | ❌ | ❌ |
| **Component exception** | ✅ | ✅ | ❌ | ❌ |
