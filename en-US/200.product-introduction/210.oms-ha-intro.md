...
The following table describes the system parameters that control the behavior of the HA module. To view and edit the parameters, log on to the OMS Community Edition console, choose **<UI-TERM>System Management</UI-TERM>** > **<UI-TERM>System Parameters</UI-TERM>**, and then search for `ha.config` on the page that appears.
