|slug|list-project-full-verify-result-of-api|
|---|---|

# 查询任务的全量校验结果

本文为您介绍 OceanBase 迁移服务（OceanBase Migration Service，OMS）社区版提供的 OpenAPI：查询任务的全量校验结果 ListProjectFullVerifyResult。

## 功能说明

本接口用于查询数据迁移任务的全量校验结果。
...
| data       | object           | 任务的全量校验结果相关信息，具体包含的信息请参见《data 数据结构》。 |
