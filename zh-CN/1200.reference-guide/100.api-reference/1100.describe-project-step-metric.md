|slug|describe-project-step-metric-of-api|
|---|---|

# 查询任务步骤的指标

本文为您介绍 OceanBase 迁移服务（OceanBase Migration Service，OMS）社区版提供的 OpenAPI：查询任务步骤的指标 DescribeProjectStepMetric。

## 功能说明

本接口用于查询数据迁移或数据同步任务的运行步骤的指标。
...
| data       | string           | 任务步骤的相关信息，具体包含的信息请参见《data 数据结构》。 |
