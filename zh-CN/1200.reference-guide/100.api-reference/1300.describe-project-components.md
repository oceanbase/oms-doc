...
本文为您介绍 OceanBase 迁移服务（OceanBase Migration Service，OMS）社区版提供的 OpenAPI：查询任务的组件信息 DescribeProjectComponents。

## 功能说明

本接口用于查询数据迁移或数据同步任务的组件信息。
...
| data       | string           | 任务组件的相关信息，具体包含的信息请参见《data 数据结构》。 |
...
* **config 数据结构**
    ...
    |     参数     |        类型        |         描述           |
    |------------|------------------|------------------------|
    | coordinator    |    map      |  详情请参见 [Coordinator 组件参数说明](../../900.o-m-manual/400.components/500.component-parameters/100.coordinator.md)。            |
    | condition    |       map   | 详情请参见 [Condition 组件参数说明](../../900.o-m-manual/400.components/500.component-parameters/200.condition.md)。              |
    | source    |       map   |    详情请参见 [Source Plugin 组件参数说明](../../900.o-m-manual/400.components/500.component-parameters/300.source-plugin/100.source-plugin-overview.md)。           |
    | sink    |      map    |  详情请参见 [Sink Plugin 组件参数说明](../../900.o-m-manual/400.components/500.component-parameters/400.sink-plugin/100.sink-plugin.md)。             |
