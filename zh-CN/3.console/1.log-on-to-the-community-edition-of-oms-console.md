...
3. 单击 **登录**。
   ...
   OMS 控制台的登录用户 admin 的默认登录密码为 `aaAA11__`。首次登录的用户，建议您在登录后尽快前往 **个人中心** 修改密码，并妥善保管新密码，以免遗忘和泄露。详情请参见 [修改登录密码](../3.console/3.user-center/2.modify-the-logon-password.md)。
