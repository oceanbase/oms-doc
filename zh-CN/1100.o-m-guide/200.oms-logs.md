...
4. 单击页面右上角的 **<UI-TERM key="oms-community.Detail.components.SyncMonitorDrawer.ViewComponentMonitoring">查看组件监控</UI-TERM>**，查看相应的 Store 组件 ID，在组件 ID 中可以获取端口信息。
   ...
   * 进入 **<UI-TERM key="oms-community.utils.hooks.useLayoutMenus.OMMonitoring">运维监控</UI-TERM>** > **<UI-TERM key="oms-community.Audit.constants.Component">组件</UI-TERM>** > **Store** 页面，单击目标 Store 后的 **<UI-TERM key="oms-community.components.Operator.openLog.ViewLogs">查看日志</UI-TERM>**。
...
4. 单击页面右上角的 **<UI-TERM key="oms-community.Migration.Detail.ViewComponentMonitoring">查看组件监控</UI-TERM>**，查看相应的 Full-Import/Incr-Sync 组件 ID。
   ...
   * 进入 **<UI-TERM key="oms-community.layout.constants.OMMonitoring">运维监控</UI-TERM>** > **<UI-TERM key="oms-community.utils.hooks.useLayoutMenus.Components">组件</UI-TERM>** > **Full-Import/Incr-Sync** 页面，单击目标 Full-Import/Incr-Sync 后的 **<UI-TERM key="oms-community.OperationComponent.Checker.MoreOperations">更多</UI-TERM>** > **<UI-TERM key="oms-community.components.Operator.openLog.ViewLogs">查看日志</UI-TERM>**。
...
4. 单击页面右上角的 **<UI-TERM key="oms-community.Detail.components.SyncMonitorDrawer.ViewComponentMonitoring">查看组件监控</UI-TERM>**，查看相应的 Full-Verification 组件 ID。
   ...
   * 进入 **<UI-TERM key="oms-community.Welcome.constants.OMMonitoring">运维监控</UI-TERM>** \> **<UI-TERM key="oms-community.utils.hooks.useLayoutMenus.Components">组件</UI-TERM>** \> **Full-Verification** 页面，单击目标 Full-Verification 后的 **<UI-TERM key="oms-community.Operation.Machine.ViewLogs">查看日志</UI-TERM>**。
