...
1. 查询 Incr-Sync/Full-Import 组件的组件 ID。
   ...
   5. 在 **<UI-TERM key="oms-community.Migration.constants.ViewComponentMonitoring">查看组件监控</UI-TERM>** 对话框，查看 **Incr-Sync 增量同步组件** 或 **Full-Import 全量导入组件** 的 **<UI-TERM key="oms-community.Detail.components.SyncMonitorDrawer.ComponentId">组件 ID</UI-TERM>**。
