...
<main id="notice" type='explain'>
    ...
    <ul>
    <li>
    <p>本文以 OceanBase 数据库 V3.x 为准获取的测试结果，OceanBase 数据库 MySQL 兼容模式支持的列类型变更规则详情请参见 <a href="https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000000221444">列类型变更规则</a>。</p>
    </li>
    <li>
