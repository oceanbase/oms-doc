|slug|delete-a-constrained-column|
|---|---|
...
如果删除的 **<UI-TERM key="oms-community.Transfer.editADB.PrimaryKeyColumn">主键列</UI-TERM>** 中包含下表中的字段类型，通过 ALTER TABLE DDL 语句进行删除列操作时，MySQL 数据库和 OceanBase 社区版的区别如下。
