...
* 当 OceanBase 数据库 V4.x 进行增量同步时，如果生成列没有标记 [STORED 属性](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000000511062)，则同步目标端时该列将同步为 NULL 值，导致下游接收该列数据时不符合预期。
