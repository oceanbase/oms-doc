...
5. 在 **更新配置** 对话框中，鼠标悬停至目标配置，单击显示的编辑图标。组件参数说明的详情请参见 [Checker 组件参数说明](/zh-CN/7.o-m-and-monitoring/7.description-of-component-parameters/3.checker-parameters.md)。
