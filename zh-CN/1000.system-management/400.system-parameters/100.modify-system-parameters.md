...
2. 在左侧导航栏，单击 **系统管理** \> **系统参数**。
   ...
   **系统参数** 页面为您详细列举每个配置项的 **参数名称**、**取值**、**所属模块**、**描述** 和 **修改时间**。
   ...
   | obmysql41_to_obmysql40_and_earlier.collation.mapping | 迁移 OceanBase 社区版 4.1.0 版本的数据至 OceanBase 社区版 4.1.0 以下版本时，数据迁移项目对不支持字符序的转换规则。 | [{"collation":"latin1_swedish_ci","mappedCollation":"utf8mb4_general_ci"}] |
   |obmysql41_to_obmysql40_and_earlier.charset.mapping|迁移 OceanBase 社区版 4.1.0 版本的数据至 OceanBase 社区版 4.1.0 以下版本时，数据迁移项目对不支持编码的转换规则。| [{"charset":"latin1","mappedCharset":"utf8mb4"}]|
