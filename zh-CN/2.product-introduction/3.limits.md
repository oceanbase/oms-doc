...
* 数据迁移和数据同步功能中，OceanBase 社区版和其它数据终端的适用版本如下。
  ...
  |      分类       |                    数据迁移             |                         数据同步                      |
  |---------------|--------------------------------|-----------------------------------------------------|
  | OceanBase 社区版 | V3.1.0-CE、V3.1.1-CE、V3.1.2-CE、V3.1.3-CE、V3.1.4-CE、V4.0-CE <br>**注意：**<br>目前 OceanBase 社区版 4.0-CE 版本仅支持作为 MySQL 数据库迁移的目标端。            | V3.1.0-CE、V3.1.1-CE、V3.1.2-CE、V3.1.3-CE、V3.1.4-CE                                          |
...
* OceanBase 云平台的适用版本为 V3.1.1-CE、V3.3.0-CE 和 V4.0-CE。
