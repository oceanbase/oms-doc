...
1. 备份数据库。
   ...
   3. 执行下述命令，手工备份 rm、cm 和 cm_hb 库为 SQL 文件，并确认三个文件的大小不为 0。
      ...
      ```
      mysqldump -h10.10.10.1 -P2883 -uroot@oms -p1234 --triggers=false rm_322 > /home/admin/rm_322.sql

      mysqldump -h10.10.10.1 -P2883 -uroot@oms -p1234 --triggers=false cm_322 > /home/admin/cm_322.sql

      mysqldump -h10.10.10.1 -P2883 -uroot@oms -p1234 --triggers=false cm_hb_322 > /home/admin/cm_hb_322bp.sql
      ```
...
4. （可选）如果您需要进行回滚操作，请执行以下步骤。
   ...
   2. 将第 1 步中备份的数据库 SQL 文件，还原为原数据库。
      ...
      mysql -h10.10.10.1 -P2883 -uroot@oms -p1234 -e "source /home/admin/rm_322.sql" -Drm_322

      mysql -h10.10.10.1 -P2883 -uroot@oms -p1234 -e "source /home/admin/cm_322.sql" -Dcm_322

      mysql -h10.10.10.1 -P2883 -uroot@oms -p1234 -e "source /home/admin/cm_hb_322.sql" -Dcm_hb_322
      ```
