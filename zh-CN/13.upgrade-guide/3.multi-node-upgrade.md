...
8. 依次升级完两个节点后，在 **系统参数** 页面，开启 HA 功能，并设置相关参数。
   ...
   <tr>
      ...
      <td>项目和组件正常运行     </td>
      <td><ul><li>项目正常运行   <li> 组件 Store 和 Incr-Sync 异常 </li>    </ul> </td>
      <td  rowspan="3">
      <ul><li>项目的状态保持不变。</li><li>HA 会根据配置新建 Store 组件，详情请参见 <a href="../10.system-management/4.system-parameters/2.modify-ha-configurations.md">修改 HA 配置</a>。 </li><li> HA 会自动启动 Incr-Sync 组件。</li> </ul> 
      </td>
   </tr>
   <tr>
      <td>项目失败     </td>
      <td><ul><li>项目失败  <li> 组件 Store 和 Incr-Sync 异常 </li>    </ul> </td>
   </tr>
   <tr>
   ...
   <tr>
      <td><ul><li> 项目为暂停状态   <li> Incr-Sync 为暂停状态   <li> Store 为运行状态  </ul>    </td>
      <td><ul><li> 项目为暂停状态   <li>Incr-Sync 为暂停状态   <li>Store 为异常状态 </ul> </td>
      <td>
      <ul>
      <li>项目和 Incr-Sync 组件的状态保持不变。</li>
