...
## 目前支持哪些版本升级至 OMS 社区版 V4.2.9-CE？

目前仅支持 OMS 社区版 V4.2.0-CE ~ V4.2.8-CE 升级至 V4.2.9-CE，不支持 V4.2.0-CE 之前版本升级至 V4.2.9-CE。
...
OMS 社区版 V4.2.7-CE 之前的版本升级至 V4.2.9-CE 时，由于老版本的数据同步任务未支持配置组件的 **并发速度**，会出现组件配置页面并发速度的档位为空的情况，选择档位后即可正常更新。
