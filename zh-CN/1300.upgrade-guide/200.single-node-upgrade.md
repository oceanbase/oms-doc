...
本文为您介绍如何单节点升级 OceanBase 迁移服务（OceanBase Migration Service，OMS）社区版至 V4.2.7-CE。
...
1. 备份数据库。
   ...
   1. 暂停 OMS 社区版 V4.2.6-CE 旧容器，记录时间 T1。
