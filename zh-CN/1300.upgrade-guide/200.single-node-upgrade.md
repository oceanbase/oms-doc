...
本文为您介绍如何单节点升级 OceanBase 迁移服务（OceanBase Migration Service，OMS）社区版至 4.2.1-CE 版本。

<main id="notice" type='notice'>
<h4>注意</h4>
<p>目前仅支持 OMS 社区版 4.2.0-CE 版本升级至 4.2.1-CE 版本，不支持 4.2.0-CE 以下版本直接升级至 4.2.1-CE 版本。</p>
</main>
...
2. 备份数据库。
   ...
   1. 暂停 OMS 社区版 4.2.0-CE 版本的旧容器，记录时间 T1。
