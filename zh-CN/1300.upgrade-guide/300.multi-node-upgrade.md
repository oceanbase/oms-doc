...
8. 依次升级完两个节点后，在 **系统参数** 页面，开启 HA 功能，并设置相关参数。
   ...
   <table>
      ...
      <ul><li> HA 会自动启动 JDBCWriter/Connector 组件。</li><li>HA 会根据配置新建 Store 组件，详情请参见 <a href="../1000.system-management/400.system-parameters/200.modify-ha-configurations.md">修改 HA 配置</a>。 </li> </ul> 
      </td>
      </tr>
      <tr>
