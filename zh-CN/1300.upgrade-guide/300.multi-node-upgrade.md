...
<ul>
<li>
<p>目前支持 OMS 社区版 V4.1.0-CE 及之后版本直接升级至 OMS 社区版 V4.2.3-CE。如果是 OMS 社区版 V4.1.0-CE 之前的版本，需要先升级至 V4.1.0-CE。</p>
<p>对于 OMS 社区版 V4.1.0-CE，您可以通过特殊升级方法直接升级至 V4.2.3-CE，详情请参见 <a href="https://www.oceanbase.com/docs/enterprise-oms-doc-cn-1000000000000113">V4.1.0-CE 升级指南</a>。如果是 OMS V4.1.0-CE 之前的版本，您可以先升级至 V4.1.0-CE，再通过特殊方法升级至 V4.2.3-CE。</p>
</li>
<li>
<p>多节点升级时，您需要升级所有节点。请勿出现部分节点升级，部分节点未升级的情况。</p>
</li>
</ul>
</main>
