...
* 创建列
  ...
  * 支持指定 check 约束（仅 OceanBase 社区版 4.0.0 版本支持），详情请参见下文的《创建索引或约束》
  ...
  * 数据类型的支持详情如下：
    ...
    <table>
        ...
        <tr>
            ...
            <td>JSON</td>
            <td>依赖于 OceanBase 社区版的版本：4.0.0 以下版本会转换为 TEXT，4.0.0 及以上版本会转换为 JSON。</td>
        </tr>
    </table>
...
* 创建索引或约束
  ...
  * OceanBase 社区版 4.0.0 及以上版本，支持创建 CHECK 约束
...
* 操作约束和索引
  ...
  * OceanBase 社区版 4.0.0 以下版本，不支持如下操作：
...
* OceanBase 社区版 4.0.0 以下版本不支持 TEMPORARY 关键字
