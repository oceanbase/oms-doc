|slug|update-the-jdbcwriter-configuration|
|---|---|
...
6. 在 **更新配置** 对话框中，鼠标悬停至目标配置，单击显示的编辑图标。组件参数说明的详情请参见 [JDBCWriter 组件参数说明](../../500.description-of-component-parameters/300.jdbcwriter-parameters.md)。
